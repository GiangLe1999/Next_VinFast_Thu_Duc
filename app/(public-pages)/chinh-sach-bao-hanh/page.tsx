...
export const generateMetadata = () => {
  return {
    ...
    description:
      "Tìm hiểu chi tiết chính sách bảo hành xe VinFast 2025: VinFast VF e34, VF 5, VF 6, VF 7, VF 8, VF 9,... tại VinFast Thủ Đức. Thông tin đầy đủ, chính xác và mới nhất.",
    alternates: {
