...
export const generateMetadata = () => {
  return {
    title: "Đăng Ký Báo Giá Xe VinFast 2025 - VinFast Quận 2",
    description:
      "Đăng ký ngay để nhận báo giá xe VinFast 2025 mới nhất tại VinFast Quận 2. Nhận thông tin chi tiết về giá bán, ưu đãi và chương trình khuyến mãi độc quyền.",
    alternates: {
