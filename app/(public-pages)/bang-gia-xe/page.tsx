...
export const generateMetadata = () => {
  return {
    title: "Bảng Giá Xe VinFast 2025 Cập Nhật Tại VinFast Hồ Chí Minh",
    description:
      "Cập nhật bảng giá xe VinFast 2025 mới nhất tại VinFast Hồ Chí Minh. Thông tin chi tiết về các dòng xe, giá bán, ưu đãi và chương trình khuyến mãi hấp dẫn.",
    alternates: {
