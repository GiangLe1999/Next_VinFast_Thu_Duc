...
export const generateMetadata = () => {
  return {
    title: "Bảng Giá Xe VinFast 2025 Cập Nhật Tại VinFast Quận 2",
    description:
      "Cập nhật bảng giá xe VinFast 2025 mới nhất tại VinFast Quận 2. Thông tin chi tiết về các dòng xe, giá bán, ưu đãi và chương trình khuyến mãi hấp dẫn.",
    alternates: {
