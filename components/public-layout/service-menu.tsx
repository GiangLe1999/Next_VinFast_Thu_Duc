...
const ServiceMenu: FC<Props> = ({ showServiceMenu }) => {
  return (
    <ul
      className={`text-gray-900 text-sm font-medium absolute w-[200px] md:w-[250px] top-full right-0 md:left-0 z-50 bg-white px-2 py-1 transition-all rounded-b-md shadow-xl origin-top border-t border-gray-100 duration-200 ease-in-out ${
        showServiceMenu
