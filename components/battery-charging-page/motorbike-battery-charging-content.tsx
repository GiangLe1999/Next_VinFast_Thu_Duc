...
const MotorbikeBatteryChargingContent = () => {
  const accordionData = [
          ...
          <table className="w-full text-sm border-collapse mb-4">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="p-3 border text-center">Giá thuê (VNĐ/tháng)</th>
                <th className="p-3 border text-center">Giới hạn quãng đường</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="p-3 border">Gói 1</td>
                <td className="p-3 border text-center font-bold">150.000</td>
                <td className="p-3 border text-center">≤ 500 km</td>
              </tr>
              <tr>
                <td className="p-3 border">Gói 2</td>
                <td className="p-3 border text-center font-bold">250.000</td>
                <td className="p-3 border text-center">&lt; 1.000 km</td>
              </tr>
              <tr>
                <td className="p-3 border">Gói 3</td>
                <td className="p-3 border text-center font-bold">350.000</td>
                <td className="p-3 border text-center">&lt; 2.000 km</td>
              </tr>
              <tr>
                <td className="p-3 border">Gói 4</td>
                <td className="p-3 border text-center font-bold">990.000</td>
                <td className="p-3 border text-center">Không giới hạn</td>
              </tr>
            </tbody>
          </table>
          <div className="bg-blue-50 p-4 rounded-lg text-sm text-blue-800">
            <strong>Lưu ý:</strong> Hệ thống tự động nâng gói (tối đa 2 lần/năm)
            nếu đi quá giới hạn. Nếu vượt quá 3 lần/năm, khách hàng buộc phải
            lên gói cao hơn.
          </div>
        </>
      ),
    ...
    {
      header: "Khách hàng đặt cọc từ 10/04/2024",
      content: (
        <table className="w-full text-sm border-collapse">
          ...
          <tbody>
            ...
            <tr>
              <td className="p-3 border">Gói 2</td>
              <td className="p-3 border text-center font-bold">350.000</td>
              <td className="p-3 border text-center">1.000 - 2.000 km</td>
            </tr>
            <tr>
              <td className="p-3 border">Gói 3</td>
              <td className="p-3 border text-center font-bold">990.000</td>
    ...
    {
      header:
        "Khách hàng đặt cọc từ 08/11/2023 (Evo200, Feliz S, Klara S 2022, Vento S, Theon S)",
      content: (
        <table className="w-full text-sm border-collapse">
          <thead className="bg-gray-100">
            <tr>
    ...
    {
      header: "Dòng xe Pin LFP (Đặt cọc trước 22/10/2022)",
      content: (
        <div className="space-y-4">
          <div>
            <h4 className="font-bold mb-2">Gói linh hoạt (Giới hạn km)</h4>
            <ul className="list-disc pl-5 text-sm text-gray-700">
              <li>
                Giá thuê: <strong>189.000đ - 249.000đ/tháng</strong> (tùy dòng
                xe)
              </li>
          ...
          <div>
            <h4 className="font-bold mb-2">Gói cố định (Không giới hạn km)</h4>
            <ul className="list-disc pl-5 text-sm text-gray-700">
              <li>
    ...
    {
      header:
        "Dòng xe thế hệ cũ (Ludo, Impes, Klara S, Theon - Trước 16/12/2022)",
      content: (
        <>
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              <tr>
                <td className="p-3 border">Siêu tiết kiệm (≤ 300km)</td>
                <td className="p-3 border text-center font-bold">149.000đ</td>
                <td className="p-3 border text-center font-bold">299.000đ</td>
              </tr>
              <tr>
                <td className="p-3 border">Tiêu chuẩn (Không giới hạn)</td>
                <td className="p-3 border text-center font-bold">220.000đ</td>
                <td className="p-3 border text-center font-bold">350.000đ</td>
              </tr>
            </tbody>
          </table>
        </>
    ...
    <div className="pt-14 pb-20">
      <div className="container mx-auto px-4">
        ...
        <section className="mb-16">
          <div className="p-8 bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <h2 className="cal-price-title mb-6">Chính sách thuê pin</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <section>
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 h-full">
              <div className="mb-6">
                <h2 className="cal-price-title mb-5">Trạm sạc công cộng</h2>

                <p className="text-sm text-gray-700 mb-2">
                  Chi phí sạc (Từ 19/03/2024)
                </p>
          ...
          <section>
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 h-full">
              <div className="space-y-6">
                <div>
                  <h2 className="cal-price-title mb-5">Quy định & Đền bù</h2>
